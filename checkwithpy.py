...
class Check:
    ...
    def __init__(self):
        ...
        try:
            self.con = sqlite3.connect('Back472.db')
    ...
    def _search_puchase(self):
        sql_query = f"SELECT * FROM Purchase WHERE id={Check.count}"
        datas = self.cur.execute(sql_query).fetchall()
        return datas
    ...
    def create_qr_code(self):
        ...
        thank_text = 'Thank you for Purchase!'
    ...
    def __index_pdf(self):
        ...
        for data in self._search_puchase():
            ...
            self.can.drawString(x,y,project)
